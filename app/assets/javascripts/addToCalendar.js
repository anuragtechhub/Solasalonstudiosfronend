(function(exports) {
  ...
  var calculateEndTime = function(start,duration) {
  ...
  var calendarGenerators = {
    ...
    google: function(event) {
      ...
      if (event.allday) {
        ...
        endTime = formatTime(calculateEndTime(event.tzstart,60*24));
  ...
  var sanitizeParams = function(params) {
    if (params.data) {
      ...
      if (params.data.duration) {
        params.data.end = new Date(params.data.start.getTime() + (params.data.duration * MS_IN_MINUTES));
      }
