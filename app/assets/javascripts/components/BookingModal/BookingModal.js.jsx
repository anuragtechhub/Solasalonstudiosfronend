var BookingModal = React.createClass({
	...
	componentWillReceiveProps: function (nextProps) {
      ...
      window.dataLayer.push({'event': 'BookNow', 'attributes': {'action': 'Open Booking Modal', 'data': data}});
		}
	},
	...
	*/
	...
	book: function () {
        ...
        window.dataLayer = window.dataLayer || [];
        window.dataLayer.push({'event': 'BookNow', 'attributes': {'action': 'Booking Complete', 'data': data}});
