class ClassImage < ActiveRecord::Base
  ...
  has_attached_file :thumbnail, path: ':class/:attachment/:id_partition/:style/:filename', styles: { large: '460x280#', small: '300x180#' }, processors: [:thumbnail, :compression], s3_protocol: :https
