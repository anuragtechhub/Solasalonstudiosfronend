class Location < ActiveRecord::Base
  ...
  has_attached_file :image_11, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_11, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_12, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_12, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_13, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_13, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_14, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_14, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_15, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_15, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_16, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_16, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_17, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_17, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_18, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_18, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_19, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
  validates_attachment_content_type :image_19, :content_type => /\Aimage\/.*\Z/       

  has_attached_file :image_20, :styles => { :carousel => '625x495#', :directory => '375x375#', :thumbnail => '100x100#' }
