class Location < ActiveRecord::Base
  ...
  has_attached_file :image_11, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_12, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_13, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_14, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_15, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_16, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_17, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_18, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_19, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
  ...
  has_attached_file :image_20, :styles => { :carousel => '625x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}
