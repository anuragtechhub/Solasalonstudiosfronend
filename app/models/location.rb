class Location < ActiveRecord::Base
  ...
  has_attached_file :image_1, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  validates_attachment_content_type :image_1, :content_type => /\Aimage\/.*\Z/
  attr_accessor :delete_image_1
  before_validation { self.image_1.destroy if self.delete_image_1 == '1' }

  has_attached_file :image_2, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  validates_attachment_content_type :image_2, :content_type => /\Aimage\/.*\Z/
  attr_accessor :delete_image_2
  before_validation { self.image_2.destroy if self.delete_image_2 == '1' }

  has_attached_file :image_3, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  validates_attachment_content_type :image_3, :content_type => /\Aimage\/.*\Z/
  attr_accessor :delete_image_3
  before_validation { self.image_3.destroy if self.delete_image_3 == '1' }

  has_attached_file :image_4, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_5, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_6, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_7, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_8, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_9, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_10, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_11, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_12, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_13, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_14, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_15, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_16, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_17, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_18, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_19, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
  ...
  has_attached_file :image_20, :styles => { :carousel => '630x>', :directory => '375x375#', :thumbnail => '100x100#' }, :s3_protocol => :https, :source_file_options => {:all => '-auto-orient'}, :convert_options => { :all => '-auto-orient' } 
