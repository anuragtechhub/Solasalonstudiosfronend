class Tool < ActiveRecord::Base
  ...
  has_attached_file :image, :path => ":class/:attachment/:id_partition/:style/:filename", :styles => { :full_width => '960>', :large => "460x280#", :small => "300x180#" }, processors: [:thumbnail, :compression], processors: [:thumbnail, :compression], :s3_protocol => :https
