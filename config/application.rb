...
module Solasalonstudios
  class Application < Rails::Application
    ...
    config.assets.precompile += ['public_website.css', 'public_website.js', 'locations.js', 'locations_state_select.js', 'salon_stylists.js', 'blog.js', 'contact_us.js', 'own_your_salon.js', 'salon_professionals.js']
