Solasalonstudios::Application.routes.draw do
  ...
  match 'booknow' => 'booknow#landing_page', :via => [:get, :post], :as => :booknow_landing_page
  match 'solagenius/booknow' => 'booknow#search', :via => [:get, :post], :as => :booknow_search
  match 'solagenius/booknow/results' => 'booknow#results', :via => [:get, :post], :as => :booknow_results
  match 'solagenius/booknow/booking-complete' => 'booknow#booking_complete', :via => [:get, :post], :as => :booknow_booking_complete
