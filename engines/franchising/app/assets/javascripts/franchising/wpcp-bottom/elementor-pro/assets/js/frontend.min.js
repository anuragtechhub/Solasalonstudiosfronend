/*! elementor-pro - v3.0.5 - 23-09-2020 */ ! function(e) {
    var t = {};
    ...
    n(172), n(19), e.exports = elementorModules.frontend.handlers.Base.extend({
        ...
        onInit: function() {
            ...
            this.swipers = {}, 1 >= this.getSlidesCount() || (this.swipers.main = new Swiper(this.elements.$mainSwiper, this.getSwiperOptions()), this.elements.$mainSwiper.data("swiper", this.swipers.main), t.pause_on_hover && this.elements.$mainSwiper.on({
                mouseenter: function() {
    ...
    i = r.extend({
        ...
        onInit: function() {
            ...
            if (this.isSlideshow() && !(1 >= e)) {
                ...
                this.swipers.main.controller.control = this.swipers.thumbs = new Swiper(this.elements.$thumbsSwiper, a), this.elements.$thumbsSwiper.data("swiper", this.swipers.thumbs), this.swipers.thumbs.controller.control = this.swipers.main
            }
        },
        onElementChange: function(e) {
            1 >= this.getSlidesCount() || (this.isSlideshow() ? (0 === e.indexOf("width") && (this.swipers.main.update(), this.swipers.thumbs.update()), 0 === e.indexOf("space_between") && this.updateSpaceBetween(this.swipers.thumbs, e)) : r.prototype.onElementChange.apply(this, arguments))
        }
    }), e.exports = function(e) {
        new i({
            $element: e
