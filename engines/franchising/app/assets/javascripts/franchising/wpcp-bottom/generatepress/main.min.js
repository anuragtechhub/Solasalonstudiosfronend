! function() {
    ...
    if ("querySelector" in document && "addEventListener" in window) {
        ...
        for (var e = document.querySelectorAll(".menu-toggle1"), t = document.querySelectorAll("nav .dropdown-menu-toggle"), n = document.querySelectorAll("nav ul a"), c = document.querySelector(".mobile-menu-control-wrapper"), i = document.body, u = document.documentElement, d = function(e) {
