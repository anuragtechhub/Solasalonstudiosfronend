class Pro::ApiController < Pro::ApplicationController
	...
	def get_userable_country(email=nil)
		...
		if userable && userable.respond_to?(:locations) && userable.locations.size >= 1
			userable.locations.first.country
		elsif userable && userable.respond_to?(:location) && userable.location
	...
	def get_userable_country_v2(email=nil)
		...
		userable.location_country if userable
	end
