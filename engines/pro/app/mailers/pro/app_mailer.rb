  ...
  class AppMailer < ActionMailer::Base
    ...
    def stylist_website_update_request_submitted(update_my_sola_website)
      if update_my_sola_website
        ...
        if @update_my_sola_website&.stylist && @update_my_sola_website.stylist.location && @update_my_sola_website.stylist.location.admin && @update_my_sola_website.stylist.location.admin.email_address
