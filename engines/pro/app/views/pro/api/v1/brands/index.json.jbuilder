...
json.array! @brands do |brand|
  ...
  json.classes brand.upcoming_classes do |klass|
    json.id klass.id
  ...
  json.deals brand.deals do |deal|
    json.id deal.id
  ...
  json.introduction_video brand.introduction_video
  ...
  json.tools brand.tools do |tool|
    json.id tool.id
  ...
  json.videos brand.brand_videos do |video|
    json.id video.id
  ...
  json.past_webinar_videos brand.past_webinar_videos do |video|
    json.id video.id
    json.title video.title
    json.description video.description
    json.duration video.duration
